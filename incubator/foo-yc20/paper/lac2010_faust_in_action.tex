...
%% TODO choose license
This paper describes how an emulation of a 1970's combo-organ was written in Faust. The Yamaha YC-20 is a fairly typical organ of its time, a transistor based relatively light instrument meant for gigging musicians. The organ can be classified as a paraphonic synthesizer. Its working principles are discussed in detail in section \ref{section:yc-20}. The emulation is written as open source as GPLv3. The process of writing the emulation is also open in the sense that it is described in this paper.
...
%% 146hz, wrong! fft scale is not 1:1 with hz, of course
