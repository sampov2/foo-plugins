...
class mydsp : public dsp {
  ...
  public:
	static void metadata(Meta* m) 	{ 
		m->declare("name", "foo schmoozcomp stereo");
	...
	virtual void buildUserInterface(UI* interface) {
		interface->openVerticalBox("foo-comp-stereo");
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		for (int i=0; i<count; i++) {
			...
			float fTemp3 = ((fSlow4 * fRec4[0]) + (fSlow3 * fRec3[0]));
			int iTemp4 = int((1048576 * (fTemp3 * fTemp3)));
			iVec1[IOTA&127] = iTemp4;
			iRec2[0] = ((iVec1[IOTA&127] + iRec2[1]) - iVec1[(IOTA-iConst23)&127]);
			float fTemp5 = (20 * log10f(sqrtf((fConst24 * float(iRec2[0])))));
			float fTemp6 = ((fSlow2 < fTemp5) * (fTemp5 - fSlow2));
			float fTemp7 = S4[int((fTemp6 < fRec1[1]))];
			fRec1[0] = ((fRec1[1] * (1 - fTemp7)) + (fTemp6 * fTemp7));
			float fTemp8 = (fSlow5 * fRec1[0]);
			float fTemp9 = (fSlow6 - fTemp8);
			S3[0] = fTemp9;
			float fTemp10 = (2 * fRec0[1]);
			S3[1] = (((fConst25 * S6[int((fTemp9 < fRec0[1]))]) + fTemp10) - fRec0[2]);
			float fTemp11 = S3[int((fabsf((0 - ((fSlow6 + fRec0[2]) - (fTemp8 + fTemp10)))) > fConst25))];
			S2[0] = fTemp11;
			S2[1] = fTemp9;
			int iTemp12 = int((fTemp11 > fTemp9));
			S1[0] = S2[iTemp12];
			float 	S7[2];
			S7[0] = fTemp9;
			S7[1] = fTemp11;
